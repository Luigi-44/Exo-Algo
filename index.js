...
// export const getLastLetters = (tablo) => {
//     return tablo.map(string => string.charAt(string.length - 1))
// }
...
export const filterLongStrings = (tablo) => {
return tablo.filter( string => string.length > 4)
};
